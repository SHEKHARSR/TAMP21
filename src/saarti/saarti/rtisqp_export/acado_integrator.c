...
a[4] = (cos(xd[2]));
a[5] = (sin(xd[2]));
a[6] = (atan((((real_t)(2.5000000000000000e-01)*xd[3])-xd[5])));
...
out[3] = ((real_t)(2.0000000000000000e+01)*(((real_t)(2.5000000000000000e-01)*u[0])-((real_t)(2.5000000000000000e-01)*a[7])));
out[4] = ((real_t)(2.0000000000000001e-01)*(u[1]+u[2]));
out[5] = (((real_t)(2.0000000000000001e-01)*(u[0]+a[7]))-(xd[4]*xd[3]));
out[6] = u[3];
}
...
a[15] = (cos(xd[2]));
a[16] = ((real_t)(1.0000000000000000e+00)/((real_t)(1.0000000000000000e+00)+(pow((((real_t)(2.5000000000000000e-01)*xd[3])-xd[5]),2))));
a[17] = ((real_t)(2.5000000000000000e-01)*a[16]);
a[18] = ((real_t)(1.0000000000000000e+00)/xd[4]);
a[19] = ((((real_t)(2.0000000000000000e+00)*od[1])*a[17])*a[18]);
a[20] = (atan((((real_t)(2.5000000000000000e-01)*xd[3])-xd[5])));
a[21] = (a[18]*a[18]);
...
a[25] = ((real_t)(2.5000000000000000e-01)*a[16]);
...
out[36] = ((real_t)(2.0000000000000000e+01)*((real_t)(0.0000000000000000e+00)-((real_t)(2.5000000000000000e-01)*a[19])));
out[37] = ((real_t)(2.0000000000000000e+01)*((real_t)(0.0000000000000000e+00)-((real_t)(2.5000000000000000e-01)*a[22])));
out[38] = ((real_t)(2.0000000000000000e+01)*((real_t)(0.0000000000000000e+00)-((real_t)(2.5000000000000000e-01)*a[24])));
out[39] = (real_t)(0.0000000000000000e+00);
out[40] = ((real_t)(5.0000000000000000e+00));
...
out[52] = (real_t)(2.0000000000000001e-01);
out[53] = (real_t)(2.0000000000000001e-01);
...
out[58] = (((real_t)(2.0000000000000001e-01)*a[26])-xd[4]);
out[59] = (((real_t)(2.0000000000000001e-01)*a[27])-xd[3]);
out[60] = ((real_t)(2.0000000000000001e-01)*a[29]);
out[61] = (real_t)(0.0000000000000000e+00);
out[62] = (real_t)(2.0000000000000001e-01);
...
acadoWorkspace.rk_diffsNew2[(i * 11) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)2.5000000000000001e-03 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-03;
}
}
...
for (i = 0; i < 7; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 11) + (run1 + 7)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)2.5000000000000001e-03 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)2.5000000000000001e-03;
}
}
